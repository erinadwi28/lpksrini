				...
				<div class="card" style="box-shadow: 0 5px 10px rgba(0, 0, 0, 0.05);">
					...
					<div class="card-body">
						<div class="mx-auto d-block">
							<a href="<?= base_url('assets/backend/images/admin/foto_profil/') . $pengguna['foto_profil']; ?>" data-gallery="mygallery" data-title="Foto Profil Saya" data-toggle="lightbox">
						<img class="rounded-circle mx-auto d-block"
								src="<?= base_url('assets/backend/images/admin/foto_profil/') . $pengguna['foto_profil']; ?>"
						...
						<hr>
						<div class="card-text">
                            <form action="<?= base_url('admin/upload_foto_profil') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="form_upload_foto_profil">
			...
			<div class="col-lg-8">
				<div class="card" style="box-shadow: 0 5px 10px rgba(0, 0, 0, 0.05);">
					<div class="card-body m-3">
						<form id="ubah_profil" method="POST" action="<?= base_url('admin/aksi_ubah_profil') ?>">
							<div class="row mb-3">
								<div class="col-sm-3">
