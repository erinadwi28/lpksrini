...
<div class="progress">
	<div class="progress-bar" role="progressbar" style="width:10%; height:5px;" aria-valuenow="25" aria-valuemin="0"
...
<div class="isi_berita">
	<div class="container mt-1" style="padding:30px;">
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<div class="alert  alert-success alert-dismissible fade show" role="alert">
					<span class="badge badge-pill badge-success">Success</span> &nbsp; Anda sudah melakukan pembelian
					pelatihan ini.
		...
		<div class="row">
			...
			<div class="col-lg-7">
				<article>
					...
					<section class="mb-5">
						...
						<img src="<?= base_url("assets/frontend/images/landing/kurikulum/$detail->kurikulum") ?>"
							alt="">
					</section>
				</article>
			</div>
			...
			<?php foreach ($transaksi as $detail) { ?>
			<?php if($detail->status == "pengajuan") {?>
			<div class="col-lg-5">
				<div class="card mb-4 border-0" style="box-shadow: 0 5px 10px rgba(0, 0, 0, 0.05);">
					...
					<div class="card-body">
						...
						<table>
							...
							<tr>
								<td><input name="id_pelatihan" id="id_pelatihan" type="hidden"
										value="<?= $detail->id_pelatihan?>"></td>
								<td><input name="id_pengguna" id="id_pengguna" type="hidden"
										value=" <?= $pengguna['id_pengguna']; ?>"></td>
							</tr>
						</table>
				...
				<div class="card mb-4 border-0" style="box-shadow: 0 5px 10px rgba(0, 0, 0, 0.05);">
					...
					<div class="card-body">
						<!-- info -->
						<p>Proses konfirmasi pembayaran pelatihan akan membutuhkan waktu sekitar 30 menit (dari pesan
							WhatsApp dikirim). Mohon menunggu dengan sabar dan terima kasih.</p>
