		...
		<div class="row">
			<div class="col-xl-12 col-lg-12">
				<div class="single_courses">
					<h3 class="second_title">Tentang kami</h3>
				</div>
					...
					<div id="accordion">
							...
							<div class="card-header" id="headingTwo">
								<h5 class="mb-0">
									<button class="btn btn-link collapsed" data-toggle="collapse"
										...
										<i class="flaticon-question"></i> Sejarah <i class="ti-angle-down"></i>
									</button>
								</h5>
							</div>
						...
						<div class="card">
							...
							<div id="collapseOne" class="collapse" aria-labelledby="headingOne"
								...
								<div class="card-body">
									<ul>
										<li>Berdiri : 6 Oktober 1987</li>
										<li>Pendiri : Sri Harini</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="card">
							<div class="card-header" id="headingThree">
								<h5 class="mb-0">
									<button class="btn btn-link collapsed" data-toggle="collapse"
										...
										<i class="flaticon-question"></i> Visi dan Misi <i class="ti-angle-down"></i>
									</button>
								</h5>
							</div>
							<div id="collapseThree" class="collapse" aria-labelledby="headingThree"
								...
								<div class="card-body">
									Visi : <br>
									Meningkatkan kualitas, Sumber Daya Manusia dan mengurangi pengangguran. <br> <br>
									Misi : <br>
									Membekali ketrampilan dan menciptakan lapangan kerja, serta
									menciptakan wirausaha yang mandiri dan juga mengadakan pelatihan-
									pelatihan.
								</div>
							</div>
						</div>
						<div class="card">
							...
							<div id="collapse_4" class="collapse" aria-labelledby="heading_4" data-parent="#accordion">
								<div class="card-body">
									Kurikulum : <br>
									Kurikulum yang di pakai dalam proses belajar adalah kurikulum pendidikan dan
